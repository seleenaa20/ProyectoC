...
Champu::Champu (int_litros, string_marca){ 
...
int main(){                  //Funcion principal
	...
	Champu = Champu(1, pantene);            //Definimos los litros y la marca del objeto
	Champu.mostrarCapacidad(); Champu.mostrarIngredientes();
